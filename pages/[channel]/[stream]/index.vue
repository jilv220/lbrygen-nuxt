...
onBeforeMount(async () => {
  ...
  try {
    ...
    if (claimDesc) {
      desc.value = claimDesc?.replaceAll("\n", "<br>");
    }
    let streamRes = await getStreamByUrl(claimShortUrl);
  ...
  <div>
    <div class="pt-16">
      <div
        v-if="streamUrl != ''"
        id="layout"
        class="grid grid-cols-3 gap-8 mt-4 px-4"
      >
        <div id="container" class="grid col-span-2">
          <div id="iframe-container">
            <video
              v-if="VIDEO_TYPES.includes(mimeType)"
              playsinline
              controls
              id="player"
            >
            ...
            <video
              v-else-if="AUDIO_TYPES.includes(mimeType)"
              playsinline
              controls
              id="player"
            >
          ...
          <div id="stream-info" class="mt-3">
            ...
            <div class="flex justify-between">
              ...
              <a
                class="btn bg-green hover:bg-green-800 text-white"
                :href="downloadUrl"
              >
                Download
              </a>
        ...
        <div id="related-videos" class="card flex-1 overflow-hidden md:px-2">
